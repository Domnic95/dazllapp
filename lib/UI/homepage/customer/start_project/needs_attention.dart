...
class _NeedAttentionState extends ConsumerState<NeedAttention> {
  ...
  @override
  Widget build(BuildContext context) {
    roomProvider = ref.watch(customerRoomsProvider);
    final size = MediaQuery.of(context).size;
    return roomProvider.isLoading || roomProvider.addNewDataLoading
        ? LoadingWidget()
        : Scaffold(
            body: Container(
              child: Padding(
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemCount: roomProvider
                            .allRoomFeature[roomProvider.tabIndex].length,
                        separatorBuilder: (BuildContext context, int index) {
                          return SizedBox(
                            height: 10,
                          );
                              ...
                              Row(
                                children: [
                                  Checkbox(
                                      ...
                                      activeColor: AppTheme.colorPrimary,
                                      value: roomProvider
                                          .allRoomFeature[roomProvider.tabIndex]
                                              [index]
                                          .selectedFeatureForOneTabs
                                          .checkBox,
                                      onChanged: (val) {
                                        roomProvider.changeCheckBox(
                                            tabIndex: roomProvider.tabIndex,
                                            selectedFeatureIndex: index,
                                            value: val!,
                                            setFeatureId: roomProvider
                                                .allRoomFeature[roomProvider
                                                    .tabIndex][index]
                                                .id);
                                      }),
                                  Text(
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    image:
                                                                      ...
                                                                      image:
                                                                          NetworkImage(
                                                                        roomProvider
                                                                            .allRoomFeature[roomProvider.tabIndex][index]
                                                                            .selectedFeatureForOneTabs
                                                                            .images[subIndex - 1],
                                                                      ),
                                                                    ),
  ...
  void openCamera(
    ...
    imgCamera = await roomProvider.imgPicker.pickImage(
      source: ImageSource.camera,
    );
  ...
  void openGallery(
    ...
    imgGallery =
        await roomProvider.imgPicker.pickImage(source: ImageSource.gallery);
    if (imgGallery != null) {
      Navigator.of(context).pop();
      textphoto(index);
    } else {
  ...
  Future<void> textphoto(int index) async {
    ...
    if (imgGallery == null) {
      ...
      roomProvider.allRoomFeature[roomProvider.tabIndex][index]
