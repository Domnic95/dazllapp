...
class SelectSavePhd extends ConsumerStatefulWidget {
  SelectSavePhd({Key? key}) : super(key: key);

  @override
  ConsumerState<SelectSavePhd> createState() => _SelectCustomerState();
}

class _SelectCustomerState extends ConsumerState<SelectSavePhd> {
  int? customerid;
                  ...
                  child: realtorProvider.filterProjectList.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return realtorProvider.filterProjectList[index]
                                        .filterProjectFinal ==
                                    1
                                ? SizedBox()
                                : Padding(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              //         .toString());
              if (realtorProvider
                  .singleComplitedPhdReport!.reports!.isNotEmpty) {
