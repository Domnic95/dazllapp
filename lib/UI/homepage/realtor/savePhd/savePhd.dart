                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final dataRoomInfo = _realtorProvider
                                  .singleComplitedPhdReport!
                                  .reports!
                                  .first
                                  .roominfo?[index];
                                              ...
                                              ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    final item = _realtorProvider
                                                        ...
                                                        .roominfo![index]
                                                        .feature?[index1];
                                                    int selectValue = _realtorProvider.singleComplitedPhdReport!.reports!.first.roominfo![index].feature?[index1].bidStatus ==
                                                                            "Pass"
                                                                        ? 3 : _realtorProvider.singleComplitedPhdReport!.reports!.first.roominfo![index].feature?[index1].bidStatus ==
                                                                            "D.I.Y"
                                                                        ?2 : _realtorProvider.singleComplitedPhdReport!.reports!.first.roominfo![index].feature?[index1].bidStatus ==
                                                                            "Bid"
                                                                        ?1:1;
                                                    return SizedBox(
                                                      child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text("${_realtorProvider.singleComplitedPhdReport!.reports!.first.roominfo![index].feature![index1].imageDesc}"),
                                                                          ),
                                                                        ),
                                                                      ],
                                                                    )
                                                                    ...
                                                                    : loader[index1] ==
                                                                        ...
                                                                        : GestureDetector(
                                                                            onTap:
                                                                              ...
                                                                              loader[index1] = true;
                                                                              setState(() {});
                                                                              final pdfFile = await PdfInvoiceApi.generate(item, _realtorProvider.singleComplitedPhdReport!.reports!.first.phdPrice.toString(), dataRoomInfo, _realtorProvider.singleComplitedPhdReport!.reports!.first.images!, _realtorProvider.singleComplitedPhdReport!.reports!.first.roomtypedata!, MediaQuery.of(context).size , selectValue);
                                                                              loader[index1] = false;
