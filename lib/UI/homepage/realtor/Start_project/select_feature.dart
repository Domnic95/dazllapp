...
class _Select_featureState extends ConsumerState<Select_feature> {
  ...
  @override
  Widget build(BuildContext context) {
    realtorRoomProvider = ref.watch(realtorRoomsProvider);
    final size = MediaQuery.of(context).size;
    return realtorRoomProvider.isLoading ||
            realtorRoomProvider.addNewDataLoading
        ? LoadingWidget()
        : Scaffold(
            body: Container(
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.separated(
                      shrinkWrap: true,
                      padding: EdgeInsets.zero,
                      itemCount: realtorRoomProvider
                          .allRoomFeature[realtorRoomProvider.tabIndex].length,
                      separatorBuilder: (BuildContext context, int index) {
                        return SizedBox(
                          height: 10,
                        );
                            ...
                            Row(
                              children: [
                                Checkbox(
                                    checkColor: lightColor,
                                    activeColor: AppTheme.colorPrimary,
                                    value: realtorRoomProvider
                                        .allRoomFeature[
                                            realtorRoomProvider.tabIndex][index]
                                        .selectedFeatureForOneTabs
                                        .checkBox,
                                    onChanged: (val) {
                                      realtorRoomProvider.changeCheckBox(
                                          tabIndex:
                                              realtorRoomProvider.tabIndex,
                                          selectedFeatureIndex: index,
                                          value: val!,
                                          setFeatureId: realtorRoomProvider
                                              .allRoomFeature[
                                                  realtorRoomProvider.tabIndex]
                                                  [index]
                                              .id);
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              color: Colors.white),
                                          child: TextFormField(
                                            controller: realtorRoomProvider
                                                .allRoomFeature[
                                                    realtorRoomProvider
                                                        .tabIndex][index]
                                                .selectedFeatureForOneTabs
                                                                ...
                                                                child:
                                                                    IconButton(
                                                                        onPressed:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            realtorRoomProvider.allRoomFeature[realtorRoomProvider.tabIndex][index].selectedFeatureForOneTabs.images.removeAt(subIndex -
                                                                                1);
                                                                          });
                                                                        },
                                                                        icon:
  ...
  void openCamera(
    ...
    imgCamera = await realtorRoomProvider.imgPicker
  ...
  void openGallery(
    ...
    imgGallery = await realtorRoomProvider.imgPicker
  ...
  Future<void> textphoto(int index) async {
    ...
    if (
      ...
      realtorRoomProvider.allRoomFeature[realtorRoomProvider.tabIndex][index]
