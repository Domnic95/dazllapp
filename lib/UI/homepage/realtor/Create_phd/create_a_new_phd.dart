...
class CreateANewPhd extends StatefulWidget {
  const CreateANewPhd({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SliderTheme(
                 data: SliderTheme.of(context).copyWith(
                        ...
                        valueIndicatorTextStyle:
                            TextStyle(color: AppTheme.white, fontSize: 14.0,fontWeight: FontWeight.bold),
                      ...
                      child: RangeSlider(
                        ...
                        onChanged: (RangeValues newRange) {
                          setState(() {
                            start = int.parse(newRange.start.toStringAsFixed(0));
                            end = int.parse(newRange.end.toStringAsFixed(0));
                          });
                        },
                      ),
              ...
              Expanded(
                child: ListView(
                  ...
                  child: ExpansionTile(iconColor: Colors.grey,  collapsedIconColor: Colors.grey, childrenPadding:
