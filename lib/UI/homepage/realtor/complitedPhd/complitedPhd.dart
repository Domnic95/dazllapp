...
class _ComplitedPhdState extends ConsumerState<ComplitedPhd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                            ...
                                            ListView.builder(
                                                ...
                                                itemBuilder: (context, index1) {
                                                  final item = _realtorProvider
                                                      ...
                                                      .roominfo![index]
                                                      .feature?[index1];
                                                  int selectValue = _realtorProvider
                                                              .singleComplitedPhdReport!
                                                              .reports!
                                                              .first
                                                              .roominfo![index]
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                        ...
                                                                        Utils.imageInfoDialog(
                                                                            context:
                                                                                context,
                                                                            url: _realtorProvider.singleComplitedPhdReport!.reports!.first.roominfo![index].feature![index1].images![subIndex]
                                                                                .toString(),
                                                                      ...
                                                                      : GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            final pdfFile = await PdfInvoiceApi.generate(
                                                                                ...
                                                                                dataRoomInfo,
                                                                                _realtorProvider.singleComplitedPhdReport!.reports!.first.images!,
                                                                                _realtorProvider.singleComplitedPhdReport!.reports!.first.roomtypedata!,
      ...
      _realtorProvider.singleComplitedPhdReport!.reports!.first.images!,
      _realtorProvider.singleComplitedPhdReport!.reports!.first.roomtypedata!,
      MediaQuery.of(context).size,selectValue
    );
await sendEmailWithPdf('pansuriyaavi8787@gmail.com', pdfFile);
...
Future<void> sendEmailWithPdf(String recipientEmail, File pdfFile) async {
  ...
  try {
    // Send the email using native email app
