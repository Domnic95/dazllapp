...
class Housedata {
  ...
  factory Housedata.fromJson(Map<String, dynamic> json) => Housedata(
      ...
      foundationType:
          json["foundation_type"] == null ? null : json["foundation_type"],
      // taxAccessedValue: json["tax_accessed_value"] == null
      //     ? null
      //     : TaxAccessedValue.fromJson(json["tax_accessed_value"]),
      taxAccessedValue: json["tax_accessed_value"] == null ? null : "",
      // TaxAccessedValue.fromJson(json["tax_accessed_value"]),
      saleDate: json["sale_date"] == null ? null : ""
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tax_accessed_value":
            taxAccessedValue == null ? null : taxAccessedValue!,
        "sale_date": saleDate == null ? null : saleDate!,
      };
}
...
class TaxAccessedValue {
  ...
  factory TaxAccessedValue.fromJson(Map<String, dynamic> json) =>
      TaxAccessedValue(
...
class The2021 {
  ...
  factory The2021.fromJson(Map<String, dynamic> json) => The2021(
        ...
        improvements:
            json["improvements"] == null ? null : json["improvements"],
      );
