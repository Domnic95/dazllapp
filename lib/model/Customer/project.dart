...
class Myproject {
    ...
    factory Myproject.fromJson(Map<String, dynamic> json) => Myproject(
        data: json["data"] == null ? [] : List<Project>.from(json["data"]!.map((x) => Project.fromJson(x))),
    );
...
class Project {
    ...
    factory Project.fromJson(Map<String, dynamic> json) => Project(
        ...
        projectOpertunity: json["projectOpertunity"] == null ? [] : List<ProjectOpertunity>.from(json["projectOpertunity"]!.map((x) => ProjectOpertunity.fromJson(x))),
        customer: json["customer"],
        roominfo: json["roominfo"] == null ? [] : List<Roominfo>.from(json["roominfo"]!.map((x) => Roominfo.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "project_id": projectId,
        "projectOpertunity": projectOpertunity == null ? [] : List<dynamic>.from(projectOpertunity!.map((x) => x.toJson())),
        "customer": customer,
        "roominfo": roominfo == null ? [] : List<dynamic>.from(roominfo!.map((x) => x.toJson())),
    };
}
...
class ProjectOpertunity {
    ...
    factory ProjectOpertunity.fromJson(Map<String, dynamic> json) => ProjectOpertunity(
        id: json["id"],
        message: json["message"],
        isInterested: json["isInterested"],
        interestDate: json["interest_date"] == null ? null : DateTime.parse(json["interest_date"]),
        projectId: json["project_id"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "interest_date": "${interestDate!.year.toString().padLeft(4, '0')}-${interestDate!.month.toString().padLeft(2, '0')}-${interestDate!.day.toString().padLeft(2, '0')}",
        "project_id": projectId,
...
class Roominfo {
    ...
    factory Roominfo.fromJson(Map<String, dynamic> json) => Roominfo(
        ...
        feature: json["feature"] == null ? [] : List<Featureinfo>.from(json["feature"]!.map((x) => Featureinfo.fromJson(x))),
    );
...
class FeatureissueElement {
    ...
    factory FeatureissueElement.fromJson(Map<String, dynamic> json) => FeatureissueElement(
        id: json["id"],
        name: json["name"],
