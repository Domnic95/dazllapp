...
class Myproject {
    ...
    factory Myproject.fromJson(Map<String, dynamic> json) => Myproject(
        data: json["data"] == null ? null : List<Project>.from(json["data"].map((x) => Project.fromJson(x))),
    );
...
class Roominfo {
    ...
    factory Roominfo.fromJson(Map<String, dynamic> json) => Roominfo(
        ...
        feature: json["feature"] == null ? null : List<Featureinfo>.from(json["feature"].map((x) => Featureinfo.fromJson(x))),
    );
